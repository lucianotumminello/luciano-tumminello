    ...
    <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-900">{language === "it" ? "Posizione" : "Location"}</h3>
      ...
      <div className="mt-8 pt-8 border-t">
        <h3 className="text-lg font-medium text-gray-900 mb-4">{language === "it" ? "Seguimi" : "Follow Me"}</h3>
