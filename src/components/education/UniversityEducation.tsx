      ...
      <CardContent className="pt-6 space-y-8">
        ...
        <div className="border-b pb-6">
          <div className="flex flex-col md:flex-row md:items-start justify-between mb-2">
            ...
            <span className="text-sm font-medium bg-primary/10 text-primary px-2 py-1 rounded-full min-w-24 w-auto md:w-auto flex items-center justify-center text-center mt-1 md:mt-0">
