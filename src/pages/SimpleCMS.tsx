...
import { CalendarIcon, Upload, FileText, Layout } from "lucide-react";
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="content"
                    placeholder="Content (supports markdown-style formatting: # for headers, - for lists, etc.)"
                  ...
                  <div className="text-xs text-gray-500">
                    Tip: Use # for main headings, ## for subheadings, - for bullet points, and leave blank lines between paragraphs
                  </div>
                </div>
              </CardContent>
            </Card>
