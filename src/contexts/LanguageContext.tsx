...
const it = {
  ...
  "about.me.para1": "La mia storia inizia a Palermo, in Sicilia. Crescere su questa isola italiana meridionale negli anni '80 ha acceso il mio interesse per il mondo oltre i confini nazionali. Imparare l'inglese dall'età di tre anni mi ha fornito uno degli strumenti principali che mi avrebbe permesso di viaggiare per il mondo e lasciare l'Italia e l'Europa.",
  ...
  "about.me.para3": "Il fascino del Sud-est asiatico mi ha attratto nel 2013, immergendomi nei diversi mercati della regione dove ho navigato tra le complessità del marketing e della pubblicità attraverso Singapore, Malesia, Indonesia e Thailandia. Questi anni in varie posizioni regionali, sia in agenzia che lato cliente, hanno rappresentato una masterclass nel guidare la crescita strategica e raggiungere risultati tangibili attraverso diversi paesaggi culturali. Il mio percorso professionale è stato ulteriormente arricchito dalla co-fondazione e costruzione di un'agenzia digitale a servizio completo da zero. Questa impresa comprendeva sviluppo web e di app, servizi creativi e marketing delle performance, servendo decine di clienti con uffici a Bangkok e Phuket e un team di circa 30 professionisti. Questo capitolo imprenditoriale mi ha fornito una preziosa visione delle complessità dello sviluppo aziendale e della leadership, consolidando la mia capacità di trasformare la visione in successo misurabile.",
