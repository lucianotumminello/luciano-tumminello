...
export const translations: TranslationData = {
  en: {
    ...
    "work.section.subtitle": "A curated selection of my recent projects and collaborations",
    "work.project1.title": "Portfolio Redesign",
    "work.project1.description": "A complete overhaul of a personal brand identity and website.",
    "work.project1.category": "Web Design",
    "work.project2.title": "Mobile App Interface",
    "work.project2.description": "UI/UX design for a health and fitness mobile application.",
    "work.project2.category": "App Design",
    "work.project3.title": "E-Commerce Platform",
    "work.project3.description": "Full stack development of a modern online shopping experience.",
    "work.project3.category": "Development",
  ...
  it: {
    ...
    "competencies.strategic.desc": "Guidare team interfunzionali diversificati e scalare organizzazioni",
    ...
    "competencies.operational.desc": "Ottimizzare i flussi di lavoro e implementare strumenti per migliorare la produttività",
    ...
    "competencies.cultural.desc": "Lavorare efficacemente in diversi mercati e con team multiculturali",
    
    // Selected Work
    "work.section.title": "Progetti Selezionati",
    "work.section.subtitle": "Una selezione curata dei miei progetti e collaborazioni recenti",
    "work.project1.title": "Redesign del Portfolio",
    "work.project1.description": "Un completo rinnovamento dell'identità del brand personale e del sito web.",
    "work.project1.category": "Web Design",
    "work.project2.title": "Interfaccia App Mobile",
    "work.project2.description": "Design UI/UX per un'applicazione mobile di salute e fitness.",
    "work.project2.category": "App Design",
    "work.project3.title": "Piattaforma E-Commerce",
    "work.project3.description": "Sviluppo full stack di un'esperienza di shopping online moderna.",
    "work.project3.category": "Sviluppo",
