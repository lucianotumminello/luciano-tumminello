  ...
  "beyond-pattern-recognition-new-ai-wave": {
    ...
    content: `
      ...
      <picture class="block my-8">
        <source media="(min-width: 768px)" srcset="/lovable-uploads/fb70c5c8-a883-4263-a22e-c7c9357768e7.png">
        <img src="/lovable-uploads/e3fee25c-7bea-488b-a94d-a2e8abe96bec.png" alt="Marketing Transformation: From Automation to Strategic Intelligence" class="mx-auto rounded-lg shadow-md w-full">
      </picture>
    ...
    contentIT: `
      ...
      <p class="mb-4 italic text-justify">"La prossima frontiera non riguarda solo modelli migliori—si tratta di orchestrare ecosistemi IA sempre più complessi per lavorare coesivamente verso obiettivi aziendali. Le organizzazioni che stanno costruendo queste capacità ora avranno un significativo vantaggio di primo arrivato." — Alexander Williams, Analista Principale presso Forrester Research</p>
      
      <h2 class="text-2xl font-bold mb-4">Chi ha scritto questo articolo</h2>
      <p class="mb-4 text-justify">Luciano Tumminello ha oltre 15 anni di esperienza nella guida della crescita in Asia-Pacifico, specializzandosi in marketing, operazioni e trasformazione digitale, con una crescente attenzione all'utilizzo dell'intelligenza artificiale. Con una comprovata esperienza nella guida di iniziative strategiche e nel conseguimento di risultati misurabili, Luciano aiuta le organizzazioni a navigare nella complessa intersezione tra tecnologia e leadership aziendale.</p>
    `
  }
};
