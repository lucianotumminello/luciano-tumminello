...
const it = {
  ...
  // Job Descriptions
  "job.spartan": "Come Direttore Operativo, guido la direzione strategica ottimizzando le operazioni e implementando la trasformazione digitale in tutti i dipartimenti. Il mio ruolo prevede l'ottimizzazione dei processi, l'implementazione di soluzioni di intelligenza artificiale e l'utilizzo dell'analisi dei dati per migliorare il processo decisionale e aumentare l'efficienza e la produttività in questa azienda italiana dedicata alla salute e al benessere.",
  "job.slow": "Come Direttore Marketing di Slow, un'azienda alimentare sostenibile con sede a Copenhagen, ho guidato team di marketing in Europa e Asia. Ho supervisionato il branding, la leadership di pensiero, la creazione di contenuti e strategie di marketing orientate alla sostenibilità che hanno aumentato la consapevolezza del marchio del 20%. Ho implementato iniziative digitali tra cui SlowTV e strumenti di marketing basati sull'IA, promuovendo la collaborazione interculturale che ha migliorato la produttività del team del 40%.",
  ...
  "job.greenpeace": "Ho guidato le attività di marketing digitale per Greenpeace Sud-est asiatico in Thailandia, Indonesia, Malesia e Filippine. Ho fornito una guida strategica che ha migliorato le prestazioni delle campagne del 20-30% e aumentato i tassi di click-through del 15% attraverso test A/B. Ho formato team locali in tutte le sedi ottimizzando i flussi di lavoro attraverso nuove soluzioni di CRM e gestione progetti.",
  "job.accor": "Ho guidato le operazioni di marketing digitale per un cluster di 5 hotel Accor in Thailandia, gestendo un team di 15 esperti digitali. Ho collaborato con diversi dipartimenti per creare campagne integrate e sviluppato una strategia di e-commerce di successo che ha aumentato le entrate online del 20%. Ho sfruttato canali digitali innovativi per incrementare le prenotazioni, rafforzare la consapevolezza del marchio e migliorare la soddisfazione dei clienti.",
  
  // Y-Digital job descriptions
  "job.ydigital.retention": "Ho guidato e formato un team di 12 professionisti di Client Services, raggiungendo oltre il 90% di fidelizzazione dei clienti e una crescita media degli account del 30%.",
  ...
  "job.dwa.strategies": "Sviluppato strategie di marketing B2B, proposte e preventivi per presentare offerte ai clienti o rispondere ai loro brief.",
  "job.dwa.relationships": "Acquisito, mantenuto e sviluppato relazioni commerciali con i clienti.",
  "job.dwa.liaison": "Operato come principale punto di contatto tra il cliente e l'agenzia.",
  "job.dwa.vendors": "Individuato fornitori e negoziato per mantenere bassi costi e margini di profitto.",
  "job.dwa.project": "Gestito progetti, inclusa pianificazione retrospettiva, tempistiche e budgeting.",
